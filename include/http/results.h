...
DECLARE_RESULT_TYPE(char *, SDSResult);
...
DEFINE_RESULT_TYPE(char *, SDSResult);
...
#define HttpOk(v)                                                              \
    _Generic((v),                                                              \
        ...
        const char **: ConstStringArrResult_Ok)(v)
...
#define HttpError(v)                                                           \
    _Generic((v),                                                              \
        ...
        const char **: ConstStringArrResult_Error)(v)
